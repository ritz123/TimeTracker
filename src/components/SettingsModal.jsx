        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'storage' && (
            <div className="space-y-5">
              <p className="text-sm text-slate-500">Your entries are stored on this device only.</p>

              <div className="w-full text-left p-4 rounded-xl border-2 border-indigo-500 bg-indigo-50/50">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-indigo-500 text-white">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      ...
                      <code className="text-[11px] bg-white/80 px-1 rounded">.weekly-tracker/</code>
